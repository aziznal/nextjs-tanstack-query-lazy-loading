  ...
  return (
    <div className="w-full border mt-12 rounded-md text-xs p-2">
      ...
      <ul className="list-decimal pl-4 flex flex-col gap-1 pt-2">
        ...
        <li>
          Having an API that supports the parameters necesssary for lazy loading
          makes a lot of work trivial.
        </li>

        <li>
          {`Tanstack's`} <code>useInfiniteQuery</code> is a great tool for this
          on the client.
        </li>
        ...
        <li>
          ...
          <ul className="list-disc pl-4 pt-1">
            <li>
              <code>cursor</code> (a.k.a offset) the starting point of the next
              page
            </li>
        ...
        <li>
          ...
          <ul className="list-disc pl-4 pt-1">
            ...
            <li>
              <code>nextCursor</code> to be used in the next request if there is
              a next page, otherwise <code>null</code> or <code>undefined</code>
            </li>

            <li>
              <code>totalItems</code> (optional) to know when to stop requesting
              more items on the client
            </li>
          </ul>
        </li>

        <li>
          Client stores all pages received so far and appends new pages to that
          list when new pages are fetched.
        </li>

        <li>
          Always let the user feel they know {`what's`} happening (with loading
